        ...
        <>
          ...
          {/* <Disclosure.Panel className="md:hidden">
            <div className="space-y-1 px-2 pt-2 pb-3">
              ...
              <Link to="/add-transaction" className="block text-gray-700 hover:bg-gray-100 px-3 py-2 rounded-md">
                Add Transaction
              </Link>
              <Link to="/add-category" className="block text-gray-700 hover:bg-gray-100 px-3 py-2 rounded-md">
                Add Category
              </Link>
              <Link to="/categories" className="block text-gray-700 hover:bg-gray-100 px-3 py-2 rounded-md">
                Categories
              </Link>
              <Link to="/profile" className="block text-gray-700 hover:bg-gray-100 px-3 py-2 rounded-md">
                Profile
              </Link>
              <Link to="/dashboard" className="block text-gray-700 hover:bg-gray-100 px-3 py-2 rounded-md">
                Dashboard
              </Link>
            </div>
