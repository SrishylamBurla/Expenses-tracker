...
import { listCategoriesAPI } from "../../serivces/categories/categoryService";
import { useMutation, useQuery } from "@tanstack/react-query";
import { useNavigate } from "react-router-dom";
import { addTransactionAPI } from "../../serivces/transactions/transactionService";
...
const TransactionForm = () => {
  const {data, isLoading, error, isError, isFetched, refetch} = useQuery({
  ...
  const {mutateAsync, isPending, error:transErr, isError:isAddTransErr,isSuccess} = useMutation({
